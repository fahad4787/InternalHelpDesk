...
import { BoxConnectionCard } from '@/components/integrations/box/box-connection-card';
import { BoxPreferencesCard } from '@/components/integrations/box/box-preferences-card';

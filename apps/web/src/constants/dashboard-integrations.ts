...
export const MARKETPLACE_APPS: MarketplaceAppMeta[] = [
  ...
  },
  {
    ...
    description: 'Joined teams and recent chats from Microsoft Teams',
    category: 'communication',
    categoryLabel: 'Communication',
  ...
  // Cloud Storage & Documents
  {
    ...
    iconKey: 'ONEDRIVE',
    name: 'OneDrive',
    description: 'Files and folders from your OneDrive account',
    category: 'storage',
  ...
  },
  {
    ...
    iconKey: 'SHAREPOINT',
    name: 'SharePoint',
    description: 'Followed sites from your SharePoint account',
    category: 'storage',
    categoryLabel: 'Cloud Storage',

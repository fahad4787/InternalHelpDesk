...
import { BoxFile } from '@/services/box.service';

export const BOX_HOME_URL = 'https://app.box.com/folder/0';
const MAX_FILES = 10;
...
function FileIcon({ file }: { file: BoxFile }) {
  if (file.isFolder) {
...
export function BoxFileList({ files }: BoxFileListProps) {

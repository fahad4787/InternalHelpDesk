...
import { SalesforceContact } from '@/services/salesforce.service';

interface SalesforceContactListProps {
  contacts: SalesforceContact[];
}

function ContactCard({ contact }: { contact: SalesforceContact }) {
  return (
...
export function SalesforceContactList({ contacts }: SalesforceContactListProps) {
  return (

...
import { Briefcase, Building2, ExternalLink, Mail, Phone } from 'lucide-react';
import { ZohoCrmContact } from '@/services/zoho-crm.service';

interface ZohoCrmContactListProps {
  contacts: ZohoCrmContact[];
}

function ContactCard({ contact }: { contact: ZohoCrmContact }) {
  return (
...
export function ZohoCrmContactList({ contacts }: ZohoCrmContactListProps) {
  return (

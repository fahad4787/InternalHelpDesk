...
import { OneDriveFile } from '@/services/onedrive.service';

export const ONEDRIVE_HOME_URL = 'https://onedrive.live.com';
const MAX_FILES = 10;

interface OneDriveFileListProps {
  files: OneDriveFile[];
}
...
function FileIcon({ file }: { file: OneDriveFile }) {
  if (file.isFolder) {
...
export function OneDriveFileList({ files }: OneDriveFileListProps) {

...
import { TEAMS_WORK_ACCOUNT_MESSAGE } from '@/lib/teams-account';

interface TeamsUnsupportedAccountCardProps {
  email?: string | null;
}

export function TeamsUnsupportedAccountCard({
  email,
}: TeamsUnsupportedAccountCardProps) {
  return (
